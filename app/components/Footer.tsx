        ...
        <div className="relative group">
          ...
          <div className="absolute top-1/2 left-0 -translate-y-1/2 w-full flex flex-col md:flex-row justify-between items-center md:items-end px-4">
            ...
            >
              ...
              <h3 className="text-2xl md:text-5xl font-light text-white/90 italic font-serif">
        ...
        <div className="mt-40 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-10">
          ...
          <div className="flex gap-8 items-center">
            {[
              {
                name: "LinkedIn",
                href: "https://www.linkedin.com/in/stojance-oreskov-b2a165356/",
                download: false,
              },
              {
                name: "GitHub",
              ...
              <a
                ...
                download={link.download ? "Stojance_Oreskov_CV.pdf" : undefined}
          ...
          <div className="text-right">
            <p className="text-[10px] text-gray-700 uppercase tracking-widest">
              ...
              <span className="text-[8px] opacity-50 italic">
