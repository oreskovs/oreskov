...
const education = [
  {
    ...
    description:
      "Successfully completed the degree with a strong foundation in modern software engineering practices, software architecture, and practical application development.",
  },
  {
    year: "2018 - 2022",
    ...
    description:
      "Developed a strong foundation in economics, organizational logic, and analytical thinking.",
  },
  {
    year: "2009 - 2018",
    ...
    description:
      "The beginning of my academic journey, where I first discovered my interest in technology.",
  },
];
            ...
            {education.map((item, index) => (
              ...
              >
                <div className="absolute left-0 md:left-1/2 transform -translate-x-1/2 z-20">
                  <div className="w-4 h-4 rounded-full bg-[#050505] border-2 border-blue-600 flex items-center justify-center">
                    <div className="w-1.5 h-1.5 rounded-full bg-blue-600 animate-pulse"></div>
                  </div>
                </div>
                <div
                  className={`w-full md:w-1/2 ${index % 2 === 0 ? "md:pr-20 md:text-right" : "md:pl-20 md:text-left"} pl-10 md:pl-0 group`}
                >
                  <motion.div
